...
public class Execution implements Runnable {
    ...
    public @continuable void run() {
        ZClass z = new ZClass();
        System.out.println("Object from opened modular package: " + z + ", ClassLoader = " + z.getClass().getClassLoader() );
        System.out.println("Running inside " + Execution.class + ", ClassLoader = " + Execution.class.getClassLoader());
        for (long i = 0; i <= 5; i++) {
